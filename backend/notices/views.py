...
class NoticeViewSet(ModelViewSet):
    queryset = EmailBot.objects.all()
    serializer_class = EmailBotSerializer
    ...
    def send(self, request, *args, **kwargs):
        ...
        if type == 'mail':
            ...
            bot_obj = EmailBot.objects.get(name=bot_name)
...
class EmailBotViewSet(ModelViewSet):
    queryset = EmailBot.objects.all()
    serializer_class = EmailBotSerializer
    search_fields = ['name']
...
class MessageToViewSet(ModelViewSet):
    queryset = MessageTo.objects.all()
    serializer_class = MessageToSerializer
    search_fields = ['name']
