...
export const componentsMap = {
  ...
  // notice
  email: () => import('@/views/notice/email'), // email bot
  telegram: () => import('@/views/notice/telegram'), // telegram bot
  to: () => import('@/views/notice/to'), // 接收者

  // stock
  stocks: () => import('@/views/stock/stocks'), // 股票信息
  stockdaily: () => import('@/views/stock/stockdaily'), // 日线行情
  stockchange: () => import('@/views/stock/stockchange'), // 股票异动
  stockfilter: () => import('@/views/stock/stockfilter'), // 股票筛选
  // is_first_zt: () => import('@/views/stock/is_first_zt'), // 检查首板


  // relax
  bingbing: () => import('@/views/relax/bingbing'), // 王冰冰
}
