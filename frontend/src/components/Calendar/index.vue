<template>
  <div class="calendar">
    <div class="calendar-tools">
      <span class="calendar-prev" @click="prevmore">
        <i class="el-icon-d-arrow-left" />
      </span>
      <span class="calendar-prev" @click="prev">
        <i class="el-icon-arrow-left" />
      </span>
      <span class="calendar-next" @click="nextmore">
      ...
      <div class="calendar-info">
        ...
        <div class="year" @click.stop="changeYear">
          <span>{{ year }}</span>
        </div>
      </div>
    </div>
    <div class="seal-result">{{ day }}</div>
    <table cellpadding="5">
      <thead>
        <tr>
    ...
    <div class="calendar-years" :class="{ show: monthsShow }">
      <span
        v-for="(y, index) in months"
        :key="index"
...
export default {
  ...
  methods: {
    ...
    prevmore(e) {
      ...
      this.$emit("prevmore", this.month, this.year);
    },
    // 上月
    prev(e) {
      e.stopPropagation();
    ...
    nextmore(e) {
      ...
      this.render(this.year, this.month);
      this.$emit("selectMonth", this.month, this.year);
      this.$emit("nextmore", this.month, this.year);
    },
    // 选中日期
    select(k1, k2, e) {
...
.calendar {
  ...
  border-radius: 16px;
  // 加背景
  background-image: url("../../assets/bingbing3.jpg");
